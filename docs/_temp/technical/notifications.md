...
- Storage: Firestore collection `notifications`.
...
- Bell + badge: `components/NotificationsBell.tsx`
...
- List view: `app/(employee)/employee/notifications/page.tsx`
...
Create a document in `notifications` with the fields above. For example:
