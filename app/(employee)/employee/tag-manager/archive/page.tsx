...
export default function TagManagerArchivePage() {
  ...
  const archived = tags.filter((t) => (t.status ?? 'active') === 'archived');
          ...
          <Card withBorder>
            <Table verticalSpacing="sm" highlightOnHover>
              ...
              <Table.Tbody>
                    ...
                    <Table.Td style={{ width: 80, minWidth: 80, whiteSpace: 'nowrap' }}>
                      <Group gap="xs" justify="flex-end" wrap="nowrap">
                        <Menu withinPortal position="bottom-end" shadow="md" width={200}>
                          ...
                          <Menu.Dropdown>
                            <Menu.Item component={Link as any} href={`/employee/tag-manager/${t.id}` as any}>View</Menu.Item>
                ...
                {archived.length === 0 && (
                  <Table.Tr>
                    <Table.Td colSpan={3}><Text c="dimmed">No archived tags</Text></Table.Td>
                  </Table.Tr>
                )}
              </Table.Tbody>
            </Table>
