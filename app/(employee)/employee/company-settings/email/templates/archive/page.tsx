...
import { listenEmailTemplates, archiveEmailTemplate, softRemoveEmailTemplate, type EmailTemplateItem } from '@/lib/firebase/emailSettings';
                    ...
                    <Table.Tr key={t.id}>
                      ...
                      <Table.Td>
                        <Menu withinPortal position="bottom-end" shadow="md" width={200}>
                          ...
                          <Menu.Dropdown>
                            <Menu.Item onClick={async () => { await archiveEmailTemplate(t.id, false); }}>Restore</Menu.Item>
