...
import { listenEmailVars, updateEmailVar, archiveEmailVar, softRemoveEmailVar, type EmailVar } from '@/lib/firebase/emailSettings';

export default function EmailVarsArchivePage() {
        ...
        <Tabs value="variables">
          ...
          <Tabs.Panel value="variables" pt="md">
                      ...
                      <Table.Td>
                        <Menu withinPortal position="bottom-end" shadow="md" width={200}>
                          ...
                          <Menu.Dropdown>
                            ...
                            <Menu.Item onClick={async () => { await archiveEmailVar(v.id, false); }}>Restore</Menu.Item>
            ...
            <Modal opened={removeOpen} onClose={() => setRemoveOpen(false)} title="Remove variable" centered>
              <Stack>
                <Text>This will move the variable to Removed. To confirm, copy and paste the key exactly as shown below.</Text>
                <Group>
                ...
                <Group justify="flex-end">
                  ...
                  <Button color="red" disabled={!removeTarget || removeConfirm !== (removeTarget?.key || '')} onClick={async () => {
                    ...
                    await softRemoveEmailVar(removeTarget.id);
                    setRemoveOpen(false);
