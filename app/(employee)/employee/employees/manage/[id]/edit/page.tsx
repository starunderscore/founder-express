...
export default function EditEmployeePage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(ref, (snap) => {
      ...
      setEmp({ id: snap.id, name: d.name || '', email: d.email || '', isAdmin: !!d.isAdmin, roleIds: Array.isArray(d.roleIds) ? d.roleIds : [], permissionIds: Array.isArray(d.permissionIds) ? d.permissionIds : [] });
    });
    return () => unsub();
  }, [params.id]);
