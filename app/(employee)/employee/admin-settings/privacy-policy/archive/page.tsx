...
import { restorePrivacyPolicy, removePrivacyPolicy, listenPrivacyPolicyEnabled } from '@/services/admin-settings/privacy-policy';
          ...
          <Group>
            ...
            <Group gap="xs" align="center">
              ...
              <div>
                ...
                <Text c="dimmed">Archived client privacy policies.</Text>
              </div>
            </Group>
          </Group>
        </Group>
          ...
          <Stack>
            ...
            <Group justify="flex-end">
              ...
              <Button onClick={async () => {
                ...
                setRefreshKey((k) => k + 1);
                toast.show({ title: 'Saved', message: 'Policy restored to Active.', color: 'green' });
              }}>Restore</Button>
            </Group>
          </Stack>
        </Modal>
