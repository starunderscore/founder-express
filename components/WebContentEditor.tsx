  ...
  return (
    <>
      <Group gap={6} wrap="wrap">
        ...
        {showLabels ? (
          <Button size="xs" variant="light" color="gray" leftSection={<IconClearFormatting size={14} />} onClick={() => editor?.chain().focus().unsetAllMarks().clearNodes().run()}>Clear formatting</Button>
        ) : (
